...
// ----------------------------------------------------------------------
export default function AcidAcetic() {
  ...
  useGLTF.preload('/model/gltf/acidaxetic.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/acidaxetic.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('acid_acetic')}<br />
                <strong>{translate('names.author')}:</strong> {translate('acid_acetic_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('acid_acetic_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
