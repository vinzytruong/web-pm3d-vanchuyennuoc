...
// ----------------------------------------------------------------------
export default function CreationProcessStarch() {
  ...
  return (
    <Page title={translate('creation_process_starch')}>
          ...
          >
            <Canvas dpr={[1, 2]} linear camera={{ fov: 40, near: 0.1, far: 3000, position: [0, 0, 50] }}>
              <Suspense fallback={<Loader />}>
                ...
                <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/quatrinhtaotinhbot.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('creation_process_starch')}<br />
                <strong>{translate('names.author')}:</strong> {translate('creation_process_starch_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('creation_process_starch_by')}<br />
              </p>
            </div>
