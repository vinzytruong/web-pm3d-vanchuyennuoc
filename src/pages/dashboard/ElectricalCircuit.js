...
export default function ElectricalCircuit() {
  ...
  return (
    <Page title={translate('electrical_circuit')}>
          ...
          >
            <Canvas dpr={[1, 2]} linear  camera={{ fov: 40, near: 0.1, far:20000, position: [0, 0, 50] }}>
              <Suspense fallback={<Loader />}>
                ...
                <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/machdien.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('electrical_circuit')}<br />
                <strong>{translate('names.author')}:</strong> {translate('electrical_circuit_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('electrical_circuit_by')}<br />
              </p>
            </div>
