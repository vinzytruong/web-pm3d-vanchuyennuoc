...
export default function Benzen() {
  ...
  useGLTF.preload('/model/gltf/benzene.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/benzene.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('benzen')}<br />
                <strong>{translate('names.author')}:</strong> {translate('benzen_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('benzen_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
