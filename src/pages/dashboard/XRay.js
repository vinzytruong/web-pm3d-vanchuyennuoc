          ...
          >
            <Canvas linear camera={{ fov: 35, near: 0.1, far: 20000 }}>
              <Suspense fallback={<Loader />}>
                ...
                <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/xquang.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('xray')}<br />
                <strong>{translate('names.author')}:</strong> {translate('xray_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('xray_by')}<br />
              </p>
            </div>
