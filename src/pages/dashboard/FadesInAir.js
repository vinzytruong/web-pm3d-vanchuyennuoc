...
// ----------------------------------------------------------------------
export default function FadesInAir() {
  ...
  return (
    <Page title={translate('fades_in_air')}>
        ...
        <FullScreen handle={screen}>
          ...
          >
            <Canvas dpr={[1, 2]} linear  camera={{ fov: 40, near: 0.1, far:20000, position: [0, 0, 50] }}>
              <Suspense fallback={<Loader />}>
                <Stage contactShadowOpacity={1}>
                  <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/tatdantrongkhongkhi.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('fades_in_air')}<br />
                <strong>{translate('names.author')}:</strong> {translate('fades_in_air_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('fades_in_air_by')}<br />
              </p>
            </div>
