...
export default function Starch() {
  ...
  useGLTF.preload('/model/gltf/tinhbot.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/tinhbot.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('starch')}<br />
                <strong>{translate('names.author')}:</strong> {translate('starch_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('starch_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
