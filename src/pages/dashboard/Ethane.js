...
// ----------------------------------------------------------------------
export default function Ethane() {
  ...
  useGLTF.preload('/model/gltf/ethane.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/ethane.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('ethane')}<br />
                <strong>{translate('names.author')}:</strong> {translate('ethane_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('ethane_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
