...
// ----------------------------------------------------------------------
export default function ResonanceOscillation() {
  ...
  return (
    <Page title={translate('resonance_oscillation')}>
          ...
          >
            <Canvas dpr={[1, 2]} linear  camera={{ fov: 40, near: 0.1, far:20000, position: [0, 0, 50] }}>
              <Suspense fallback={<Loader />}>
                ...
                <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/conghuong.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('resonance_oscillation')}<br />
                <strong>{translate('names.author')}:</strong> {translate('resonance_oscillation_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('resonance_oscillation_by')}<br />
              </p>
            </div>
