...
export default function AminoAcid() {
  ...
  useGLTF.preload('/model/gltf/aminoacid.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/aminoacid.gltf')
  ...
  return (
    <Page title={translate('amino_acid')}>
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('amino_acid')}<br />
                <strong>{translate('names.author')}:</strong> {translate('amino_acid_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('amino_acid_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
