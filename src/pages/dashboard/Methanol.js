...
export default function Methanol() {
  ...
  useGLTF.preload('/model/gltf/methanol.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/methanol.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('methanol')}<br />
                <strong>{translate('names.author')}:</strong> {translate('methanol_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('methanol_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
