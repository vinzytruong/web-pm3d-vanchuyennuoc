...
export default function Fructozo() {
  ...
  useGLTF.preload('/model/gltf/fructozo.gltf');
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/fructozo.gltf');
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong> {translate('fructozo')}
                <br />
                <strong>{translate('names.author')}:</strong> {translate('fructozo_author')}
                <br />
                <strong>{translate('names.by')}:</strong> {translate('fructozo_by')}
                <br />
              </p>
            </div>
          </Card>
