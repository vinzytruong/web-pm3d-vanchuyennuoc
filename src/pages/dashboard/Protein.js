...
export default function Protein() {
  ...
  useGLTF.preload('/model/gltf/protein.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/protein.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('protein')}<br />
                <strong>{translate('names.author')}:</strong> {translate('protein_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('protein_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
