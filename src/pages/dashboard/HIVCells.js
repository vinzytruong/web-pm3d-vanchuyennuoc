...
// ----------------------------------------------------------------------
export default function HIVCells() {
  ...
  useGLTF.preload('/model/gltf/tebaohiv.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/tebaohiv.gltf')
  ...
  return (
    <Page title={translate('hiv_cells')}>
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('hiv_cells')}<br />
                <strong>{translate('names.author')}:</strong> {translate('hiv_cells_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('hiv_cells_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
