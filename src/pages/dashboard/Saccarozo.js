...
export default function Saccarozo() {
  ...
  useGLTF.preload('/model/gltf/saccarozo.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/saccarozo.gltf')
  ...
  return (
    <Page title={translate('saccarozo')}>
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('saccarozo')}<br />
                <strong>{translate('names.author')}:</strong> {translate('saccarozo_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('saccarozo_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
