...
// ----------------------------------------------------------------------
export default function NuclearStructure() {
  ...
  return (
    <Page title={translate('nuclearStructure')}>
          ...
          >
            <Canvas dpr={[1, 2]} linear  camera={{ fov: 40, near: 0.1, far:20000, position: [0, 0, 50] }}>
              <Suspense fallback={<Loader />}>
                ...
                <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/cautaohatnhan.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('nuclearStructure')}<br />
                <strong>{translate('names.author')}:</strong> {translate('nuclearStructure_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('nuclearStructure_by')}<br />
              </p>
            </div>
