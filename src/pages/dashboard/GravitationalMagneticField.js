...
// ----------------------------------------------------------------------
export default function GravitationalMagneticField() {
  ...
  return (
    <Page title={translate('gravitational_magnetic_field')}>
          ...
          >
            <Canvas dpr={[1, 2]} linear  camera={{ fov: 40, near: 0.1, far:20000, position: [0, 0, 50] }}>
              <Suspense fallback={<Loader />}>
                ...
                <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/truonghapdanthehapdan.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('gravitational_magnetic_field')}<br />
                <strong>{translate('names.author')}:</strong> {translate('gravitational_magnetic_field_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('gravitational_magnetic_field_by')}<br />
              </p>
            </div>
