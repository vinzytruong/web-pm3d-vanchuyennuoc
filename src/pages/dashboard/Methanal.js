...
// ----------------------------------------------------------------------
export default function Methanal() {
  ...
  useGLTF.preload('/model/gltf/methanal.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/methanal.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('methanal')}<br />
                <strong>{translate('names.author')}:</strong> {translate('methanal_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('methanal_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
