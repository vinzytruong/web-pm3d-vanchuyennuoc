...
export default function HepatitisB() {
  ...
  useGLTF.preload('/model/gltf/virusviemganb.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/virusviemganb.gltf')
  ...
  return (
    <Page title={translate('hepatitisB')}>
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('hepatitisB')}<br />
                <strong>{translate('names.author')}:</strong> {translate('hepatitisB_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('hepatitisB_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
