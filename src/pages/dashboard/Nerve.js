...
export default function Nerve() {
  ...
  useGLTF.preload('/model/gltf/hethankinh.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/hethankinh.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('nerve')}<br />
                <strong>{translate('names.author')}:</strong> {translate('nerve_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('nerve_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
