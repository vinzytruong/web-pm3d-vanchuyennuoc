        ...
        <FullScreen handle={screen}>
          ...
          >
            <Canvas linear camera={{ fov: 35, near: 0.1, far: 20000 }}>
              <Suspense fallback={<Loader />}>
                <Stage contactShadowOpacity={1}>
                  <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/nhatthuc.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('eclipse')}<br />
                <strong>{translate('names.author')}:</strong> {translate('eclipse_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('eclipse_by')}<br />
              </p>
            </div>
