...
// ----------------------------------------------------------------------
export default function Saponification() {
  ...
  return (
    <Page title={translate('saponification')}>
          ...
          >
            ...
            <Canvas dpr={[1, 2]} linear camera={{ fov: 35, near: 0.1, far: 3000 }} >
              <Suspense fallback={<Loader />}>
                ...
                <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/xaphonghoa.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong> {translate('saponification')}
                <br />
                <strong>{translate('names.author')}:</strong> {translate('saponification_author')}
                <br />
                <strong>{translate('names.by')}:</strong> {translate('saponification_by')}
                <br />
              </p>
            </div>
