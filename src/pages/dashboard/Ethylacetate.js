...
// ----------------------------------------------------------------------
export default function EthyAcetate() {
  ...
  useGLTF.preload('/model/gltf/ethylaxetate.gltf');
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/ethylaxetate.gltf');
  ...
  return (
    <Page title={translate('ethylaxetate')}>
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong> {translate('ethylaxetate')}
                <br />
                <strong>{translate('names.author')}:</strong> {translate('ethylaxetate_author')}
                <br />
                <strong>{translate('names.by')}:</strong> {translate('ethylaxetate_by')}
                <br />
              </p>
            </div>
          </Card>
