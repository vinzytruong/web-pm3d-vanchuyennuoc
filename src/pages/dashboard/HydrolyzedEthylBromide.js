...
export default function HydrolyzedEthylBromide() {
  ...
  return (
    <Page title={translate('hydrolyzed_ethyl_bromide')}>
          ...
          >
            <Canvas camera={{ fov: 45 }}>
              <Suspense fallback={<Loader />}>
                ...
                <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/thuyphanethylbromide.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong> {translate('hydrolyzed_ethyl_bromide')}
                <br />
                <strong>{translate('names.author')}:</strong> {translate('hydrolyzed_ethyl_bromide_author')}
                <br />
                <strong>{translate('names.by')}:</strong> {translate('hydrolyzed_ethyl_bromide_by')}
                <br />
              </p>
            </div>
