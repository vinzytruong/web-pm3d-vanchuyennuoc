...
export default function H2O() {
    ...
    useGLTF.preload('/model/gltf/nacl.gltf')
    function Model(props) {
        const { scene, animations } = useGLTF('/model/gltf/nacl.gltf')
            ...
            <Container maxWidth={themeStretch ? false : 'lg'}>
                ...
                >
                    ...
                    <div style={description}>
                        <p>
                            <strong>{translate('names.model')}:</strong>  {translate('nacl')}<br />
                            <strong>{translate('names.author')}:</strong> {translate('nacl_author')}<br />
                            <strong>{translate('names.by')}:</strong> {translate('nacl_by')}<br />
                        </p>
                    </div>
                </Card>
                </FullScreen>
