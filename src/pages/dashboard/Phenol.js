...
// ----------------------------------------------------------------------
export default function Phenol() {
  ...
  useGLTF.preload('/model/gltf/phenol.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/phenol.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('phenol')}<br />
                <strong>{translate('names.author')}:</strong> {translate('phenol_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('phenol_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
