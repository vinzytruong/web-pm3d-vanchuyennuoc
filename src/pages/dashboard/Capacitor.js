          ...
          >
            <Canvas dpr={[1, 2]} linear  camera={{ fov: 40, near: 0.1, far:20000, position: [0, 0, 50] }}>
              <Suspense fallback={<Loader />}>
                ...
                <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/tudien.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('capacitor')}<br />
                <strong>{translate('names.author')}:</strong> {translate('capacitor_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('capacitor_by')}<br />
              </p>
            </div>
