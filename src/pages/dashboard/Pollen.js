          ...
          >
            <Canvas dpr={[1, 2]}  camera={{ fov: 45, near: 0.1, far: 4000, position: [0, 0, 50] }}>
              <Suspense fallback={<Loader />}>
                ...
                <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/phanhoa.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('pollen')}<br />
                <strong>{translate('names.author')}:</strong> {translate('pollen_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('pollen_by')}<br />
              </p>
            </div>
