...
// ----------------------------------------------------------------------
export default function Anilin() {
  ...
  useGLTF.preload('/model/gltf/maltose.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/maltose.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('maltose')}<br />
                <strong>{translate('names.author')}:</strong> {translate('maltose_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('maltose_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
