...
export default function Battery() {
  ...
  useGLTF.preload('/model/gltf/pin.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/pin.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('battery')}<br />
                <strong>{translate('names.author')}:</strong> {translate('battery_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('battery_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
