...
// ----------------------------------------------------------------------
export default function Methylamine() {
  ...
  useGLTF.preload('/model/gltf/methylamine.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/methylamine.gltf')
  ...
  return (
    <Page title={translate('methylamine')}>
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('methylamine')}<br />
                <strong>{translate('names.author')}:</strong> {translate('methylamine_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('methylamine_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
