...
// ----------------------------------------------------------------------
export default function FadesInOil() {
  ...
  return (
    <Page title={translate('fades_in_oil')}>
          ...
          >
            <Canvas dpr={[1, 2]} linear  camera={{ fov: 40, near: 0.1, far:20000, position: [0, 0, 50] }}>
              <Suspense fallback={<Loader />}>
                ...
                <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/tatdantrongdau.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('fades_in_oil')}<br />
                <strong>{translate('names.author')}:</strong> {translate('fades_in_oil_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('fades_in_oil_by')}<br />
              </p>
            </div>
