...
export default function Anilin() {
  ...
  useGLTF.preload('/model/gltf/anilin.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/anilin.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('aniline')}<br />
                <strong>{translate('names.author')}:</strong> {translate('aniline_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('aniline_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
