...
export default function Cardiovascular() {
  ...
  return (
    <Page title={translate('cardiovascular')}>
          ...
          >
            <Canvas dpr={[1, 2]}  camera={{ fov: 45, near: 0.1, far: 4000, position: [0, 0, 50] }}>
              <Suspense fallback={<Loader />}>
                ...
                <Model pause={isPause} events={events} setEvents={setEvents} src='/model/gltf/hoatdonghetimmach.gltf' eventsData={(e) => setEvents(e)} reload={isReload}/>
                </Stage>
              </Suspense>
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('cardiovascular')}<br />
                <strong>{translate('names.author')}:</strong> {translate('cardiovascular_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('cardiovascular_by')}<br />
              </p>
            </div>
