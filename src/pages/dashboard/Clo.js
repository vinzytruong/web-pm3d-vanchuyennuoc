...
export default function Clo() {
    ...
    useGLTF.preload('/model/gltf/clo.gltf')
    function Model(props) {
        const { scene, animations } = useGLTF('/model/gltf/cl2.gltf')
                ...
                <FullScreen handle={screen}>
                    ...
                    >
                        ...
                        <div style={description}>
                            <p>
                                <strong>{translate('names.model')}:</strong>  {translate('clo')}<br />
                                <strong>{translate('names.author')}:</strong> {translate('clo_author')}<br />
                                <strong>{translate('names.by')}:</strong> {translate('clo_by')}<br />
                            </p>
                        </div>
                    </Card>
                </FullScreen>
