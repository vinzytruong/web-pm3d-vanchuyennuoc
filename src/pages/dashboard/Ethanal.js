...
// ----------------------------------------------------------------------
export default function Benzen() {
  ...
  useGLTF.preload('/model/gltf/ethanal.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/ethanal.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('ethanal')}<br />
                <strong>{translate('names.author')}:</strong> {translate('ethanal_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('ethanal_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
