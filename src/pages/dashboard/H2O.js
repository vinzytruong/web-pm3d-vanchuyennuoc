...
export default function H2O() {
    ...
    useGLTF.preload('/model/gltf/h2o.gltf')
    function Model(props) {
        const { scene, animations } = useGLTF('/model/gltf/h2o.gltf')
                ...
                <FullScreen handle={screen}>
                    ...
                    >
                        ...
                        <div style={description}>
                            <p>
                                <strong>{translate('names.model')}:</strong>  {translate('h2o')}<br />
                                <strong>{translate('names.author')}:</strong> {translate('h2o_author')}<br />
                                <strong>{translate('names.by')}:</strong> {translate('h2o_by')}<br />
                            </p>
                        </div>
                    </Card>
                </FullScreen>
