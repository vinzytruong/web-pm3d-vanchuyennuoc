...
// ----------------------------------------------------------------------
export default function Acetylene() {
  ...
  useGLTF.preload('/model/gltf/axetylen.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/axetylen.gltf')
  ...
  return (
    <Page title={translate('acetylene')}>
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('acetylene')}<br />
                <strong>{translate('names.author')}:</strong> {translate('axetylen_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('axetylen_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
