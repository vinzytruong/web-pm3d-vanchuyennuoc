...
export default function Methane() {
  ...
  useGLTF.preload('/model/gltf/methane.gltf')
  function Model(props) {
    const { scene, animations } = useGLTF('/model/gltf/methane.gltf')
        ...
        <FullScreen handle={screen}>
          ...
          >
            ...
            <div style={description}>
              <p>
                <strong>{translate('names.model')}:</strong>  {translate('methane')}<br />
                <strong>{translate('names.author')}:</strong> {translate('methane_author')}<br />
                <strong>{translate('names.by')}:</strong> {translate('methane_by')}<br />
              </p>
            </div>
          </Card>
        </FullScreen>
