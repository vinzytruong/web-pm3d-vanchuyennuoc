    ...
    <RootStyle>
      <Container component={MotionViewport} sx={{ position: 'relative', textAlign: 'center' }}>
        ...
        <m.div variants={varFade().inUp}>
          ...
          >
            Chế độ màu sắc tùy ý chỉ, bạn chỉ cần bấm chuột và chọn.
          </Typography>
        </m.div>
          ...
          <Box sx={{ position: 'absolute', top: 0 }}>
            <m.div variants={varFade().inUp}>
              <Image
                disabledEffect
                alt="screen"
                src={`/images/home/screen-${themeColorPresets}.png`}
              />
            </m.div>
          </Box>
            ...
            <m.div variants={varFade().inDown}>
              <m.div animate={{ y: [0, -15, 0] }} transition={{ duration: 8, repeat: Infinity }}>
                <Image
                  disabledEffect
                  alt="sidebar"
                  src={`/images/home/block1-${themeColorPresets}.png`}
                />
              </m.div>
            </m.div>
          </Box>
            ...
            <m.div variants={varFade().inDown}>
              <m.div animate={{ y: [-25, 5, -25] }} transition={{ duration: 10, repeat: Infinity }}>
                <Image
                  disabledEffect
                  alt="sidebar"
                  src={`/images/home/sidebar-${themeColorPresets}.png`}
                />
              </m.div>
            </m.div>
          </Box>
