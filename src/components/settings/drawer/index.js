            ...
            <RootStyle {...varSidebar}>
              ...
              <Scrollbar sx={{ flexGrow: 1 }}>
                <Stack spacing={3} sx={{ p: 3 }}>
                  ...
                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Độ sáng</Typography>
                    <SettingContrast />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Hướng xem</Typography>
                    <SettingDirection />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Bố trí</Typography>
                    <SettingLayout />
                  </Stack>
                  ...
                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Kéo dài</Typography>
                    <SettingStretch />
                  </Stack>
